...
#define syn_gfx_pixel(ctx, x, y, color) \
    syn_canvas_pixel((ctx), (x), (y), (color)) /**< Draw pixel. */
#define syn_gfx_line(ctx, x0, y0, x1, y1, color) \
    syn_canvas_line((ctx), (x0), (y0), (x1), (y1), (color)) /**< Draw line. */
#define syn_gfx_rect(ctx, x, y, w, h, color) \
    syn_canvas_rect((ctx), (x), (y), (w), (h), (color)) /**< Draw rect outline. */
#define syn_gfx_rect_fill(ctx, x, y, w, h, color) \
    syn_canvas_rect_fill((ctx), (x), (y), (w), (h), (color)) /**< Draw filled rect. */
#define syn_gfx_circle(ctx, cx, cy, r, color) \
    syn_canvas_circle((ctx), (cx), (cy), (r), (color)) /**< Draw circle outline. */
#define syn_gfx_circle_fill(ctx, cx, cy, r, color) \
    syn_canvas_circle_fill((ctx), (cx), (cy), (r), (color)) /**< Draw filled circle. */
#define syn_gfx_rect_round(ctx, x, y, w, h, r, color) \
    syn_canvas_rect_round((ctx), (x), (y), (w), (h), (r), (color)) /**< Draw rounded rect. */
#define syn_gfx_rect_round_fill(ctx, x, y, w, h, r, color)     \
    syn_canvas_rect_round_fill((ctx), (x), (y), (w), (h), (r), \
                               (color)) /**< Draw filled rounded rect. */
#define syn_gfx_bitmap(ctx, x, y, bmp, w, h, color) \
    syn_canvas_bitmap((ctx), (x), (y), (bmp), (w), (h), (color)) /**< Draw 1-bit bitmap. */
#define syn_gfx_hline(ctx, x, y, w, color) \
    syn_canvas_hline((ctx), (x), (y), (w), (color)) /**< Horizontal line. */
#define syn_gfx_vline(ctx, x, y, h, color) \
    syn_canvas_vline((ctx), (x), (y), (h), (color)) /**< Vertical line. */
/** @} */
...
#define syn_gfx_text(ctx, x, y, str, color) \
    syn_canvas_text((ctx), (x), (y), (str), (color)) /**< Draw text string. */
#define syn_gfx_char(ctx, x, y, ch, color) \
    syn_canvas_char((ctx), (x), (y), (ch), (color)) /**< Draw single char. */
#define syn_gfx_text_width(ctx, str)                                                  \
    syn_canvas_text_width((ctx), (str))                      /**< Measure text width. \
                                                              */
...
#define syn_gfx_set_clip(ctx, x, y, w, h) \
    syn_canvas_set_clip((ctx), (x), (y), (w), (h))         /**< Set clip rectangle. */
