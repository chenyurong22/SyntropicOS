...
typedef struct {
    ...
    uint8_t
        industry_group; /**< 3-bit Industry Group (e.g. 0=Global, 1=On-Highway, 2=Agricultural) */
 ...
 * @return SYN_OK if a complete J1939 message is ready, or SYN_BUSY if multi-packet assembly is in
 * progress.
 */
