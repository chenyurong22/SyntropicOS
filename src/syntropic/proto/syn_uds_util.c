/**
 * @file syn_uds_util.c
 * @brief SAE J2012 / ISO 15031-6 UDS Diagnostic Trouble Code (DTC) Utilities Implementation.
 */
...
/**
 * @brief Convert single hex character to 4-bit nibble value.
 * @param c Input character ('0'-'9', 'a'-'f', 'A'-'F').
 * @return Nibble value (0-15), or -1 if invalid hex char.
 */
