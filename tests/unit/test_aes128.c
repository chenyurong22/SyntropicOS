...
{
    const uint8_t key[16] = { 'S','y','n','t','r','o','p','i','c','O','S','K','e','y','1','2' };
    const uint8_t iv[16]  = { 'I','n','i','t','V','e','c','t','o','r','1','2','3','4','5','6' };
    ...
    uint8_t plain[128] = {0};
    size_t plain_len = 0;
    TEST_ASSERT_EQUAL(SYN_OK, syn_aes128_cbc_decrypt(&ctx, iv, cipher, cipher_len,
