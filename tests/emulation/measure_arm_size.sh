...
arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -std=c99 -O2 -ffunction-sections -fdata-sections -fstack-usage -I. -Isrc -c src/syntropic/util/syn_dsp.c -o build/syn_dsp_arm.o
