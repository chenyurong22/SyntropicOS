/**
 * @file syn_usb_hid.c
 * @brief Zero-Heap USB 2.0 Human Interface Device (HID) Class Driver Implementation.
 */
...
/**
 * @brief Class setup request dispatcher for HID class requests.
 *
 * @param ctx Pointer to SYN_USB_HID instance.
